    ...
    /*private void sincronizarContador() {
        try {
            ...
            if (ultimoId != null && ultimoId.startsWith("PR")) {
                ...
                System.out.println("Contador de producto sincronizado: siguiente PR" + (numero + 1));
            }
        } catch (NoResultException e) {
            Producto.setContador(1000);
            System.out.println("ℹNo hay productos registrados. Contador iniciado en PR1000.");
        } catch (Exception e) {
            Producto.setContador(1000);
            System.err.println("Error al sincronizar el contador de productos, se mantiene en PR1000: " + e.getMessage());
        }
    }
